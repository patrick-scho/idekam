...
#define NUMARGS(...) (sizeof((Expression[]){__VA_ARGS__})/sizeof(Expression))
#define CALL(f, ...) (Expression){.kind = E_CALL,.e.c = (CallExpression){f, (Expression[]){__VA_ARGS__},NUMARGS(__VA_ARGS__)}}
